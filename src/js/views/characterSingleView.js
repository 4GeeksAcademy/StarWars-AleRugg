        ...
        <div id="carouselBasicExample" className="carousel slide carousel-fade" data-mdb-ride="carousel" data-mdb-carousel-init>
          ...
          <div className="carousel-inner">
            ...
            <div className="carousel-item active">
              <img src="https://wallpaperaccess.com/full/168208.jpg" className="carouselImg" alt="Sunset Over the City"/>
              <div className="carousel-caption d-none d-md">
            ...
            <div className="carousel-item">
              <img src="https://mdbcdn.b-cdn.net/img/Photos/Slides/img%20(22).webp" className="carouselImg" alt="Canyon at Nigh"/>
              <div className="carousel-caption d-none d-md">
            ...
            <div className="carousel-item">
              <img src="https://mdbcdn.b-cdn.net/img/Photos/Slides/img%20(23).webp" className="carouselImg" alt="Cliff Above a Stormy Sea"/>
              <div className="carousel-caption d-none d-md">
